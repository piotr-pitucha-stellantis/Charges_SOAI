...
df = pd.read_json('/Workspace/Repos/ugo.merlier@stellantis.com/CHRG00/Dase/Request/config.json')
...
print("Path plugs : " + dbutils.widgets.get('Data_path_S3')+folder_name+"/levdata/plugs")
